"""
This file is not relevant anymore. Tried deploying using lambda container, but it did not work.
Lambda env can only write to /tmp, but cannot modify model download file location. 
"""
import os
import boto3
import botocore
